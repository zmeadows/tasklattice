...
from tasklattice.source import Source, SourceIndex
...
def test_pos_to_line_col_basic() -> None:
    ...
    assert s.pos_to_line_col(SourceIndex(3)) == (2, 1)  # 'c'
    assert s.pos_to_line_col(SourceIndex(5)) == (2, 3)  # end of CRLF line
    assert s.pos_to_line_col(SourceIndex(8)) == (4, 1)  # caret at EOF (line 4 start)
